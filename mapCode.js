...
function addMarker(location) {
      ...
      function getLocations(){
        //Query the webapp 
        //list of [{lat: 0, lng: 0, state: filled, chance: .95}]
      ...
      function getColor(state, chance){
        if(state == "filled")
        {
          return rgbToHex(mapVal(chance, 0, 1, 255, 0), mapVal(chance, 0, 1, 0, 255), 0);
        }
        return rgbToHex(0, mapVal(chance, 0, 1, 255, 0), mapVal(chance, 0, 1, 0, 255));
      }
